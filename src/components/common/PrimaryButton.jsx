...
function PrimaryButton({ sectionEnquired }) {
  ...
  return (
    <div
      type="button"
      className="text-indigo-600 bg-white rounded-2xl border-indigo-600 border-solid border-[3px] justify-center px-4 py-2 text-2xl font-medium focus:outline-none hover:bg-green-600 hover:border-green-600 hover:text-white focus:ring-4 focus:ring-purple-300 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 hover:cursor-pointer"
